...
IMG_APPLE_SLICE = load_image("appleslice.png", (58, 58))  # -10% (64 * 0.9 = 57.6 ≈ 58)
IMG_BANANA = load_image("banana.png", (80, 64))
IMG_BANANA_SLICE = load_image("bananaslice.png", (72, 58))  # -10% (80 * 0.9 = 72, 64 * 0.9 = 57.6 ≈ 58)
IMG_ORANGE = load_image("orange.png", (64, 64))
IMG_ORANGE_SLICE = load_image("orangeslice.png", (58, 58))  # -10%


IMG_ICE = load_image("icecube.png", (64, 64))
IMG_BOMB = load_image("bomb.png", (74, 74))
IMG_GOLDENFRUIT = load_image("goldenfruit.png", (64, 64))
IMG_GOLDENFRUIT_SLICE = load_image("goldenfruitslice.png", (58, 58))  # -10%
